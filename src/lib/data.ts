...
export const dummyMenuItems: MenuItem[] = [
  {
    id: "1",
    nama: "Fried Chicken Original",
    harga: 5000,
    deskripsi: "Potongan dada, paha bawah, paha atas dan sayap ayam dengan daging tebal dan juicy, dibalut tepung krispy gurih.",
    image_url: original,
  ...
  },
  {
    ...
    nama: "Ayam Geprek",
    harga: 7000,
    deskripsi: "Potongan dada, paha bawah, paha atas dan sayap ayam dengan daging tebal dan juicy, dibalut tepung krispy gurih, digeprek dengan sekuat tenaga dan dilumuri bumbu cabai yang pedas nya nikmat.",
    image_url: menuPaha,
    kategori: "Ayam Goreng",
  },
  {
    ...
    nama: "Chicken C'lup",
    harga: 13000,
    deskripsi: "Potongan dada, paha bawah, paha atas dan sayap ayam dengan daging tebal dan juicy, dibalut tepung krispy gurih, ditambah dengan bumbu c'lup yang pedas, favorit pelanggan",
  ...
  },
  {
    ...
    nama: "Bakakak",
    harga: 55000,
    deskripsi: "1 ekor ayam utuh yang dilumuri bumbu dengan kulit yang krispy dan daging nya yang juicy, cocok dimakan bersama keluarga.",
    image_url: menuSayap,
    kategori: "Ayam Goreng",
  },
];
